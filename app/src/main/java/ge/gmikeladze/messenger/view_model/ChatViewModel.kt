...
class ChatViewModel : ViewModel() {
    ...
    fun initUser(username: String) {
        ...
        database.getReference(DATABASE_USERS).child(username).get().addOnSuccessListener {
    ...
    fun sendMessage(id: String, receiver: String, message: Message) {
        val database = Firebase.database
        val chatMap: Map<String, Any> =
            mapOf("lastMessage" to message.message as Any, "lastMessageTime" to message.time as Any)
